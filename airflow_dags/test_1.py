...
#
# to do: Define a function for the PythonOperator to call and have it log something
#
def greet():
...
#
# to do: Uncomment the operator below and replace the arguments labeled <REPLACE> below
#
